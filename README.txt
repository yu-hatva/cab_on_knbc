...
(v0.2) driver5.csh を追加しました。これは係ろっと専用で、正答率チェックを高速に実行するものです。driver3では１文ずつperlからcabochaを呼んでいましたが、drvier5ではC++の中でループし、cabochaを呼ぶのは一度だけとしました。
...
【変更履歴】
v0.1  10/20/2012 初版
v0.2  11/06/2012 driver5（係ろっと用高速チェック）を追加
